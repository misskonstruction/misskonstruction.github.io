...
export const Route = createFileRoute("/gallery/travel")({
  ...
  head: () => ({
    meta: [
      { title: "Travel — Coming Soon | MissKonstruction Photography" },
      { name: "description", content: "Photographs from the road and beyond — coming soon." },
    ...
    <SiteLayout>
      <section className="container mx-auto px-4 py-12 md:py-16">
        <header className="text-center max-w-xl mx-auto mb-12">
          <h1 className="text-4xl md:text-5xl font-bold">Travel — Coming Soon</h1>
          <img
          ...
          <p className="text-muted-foreground">
            ...
            hand. The first set of travel photos is on its way. Check back soon.
          </p>
        </header>
