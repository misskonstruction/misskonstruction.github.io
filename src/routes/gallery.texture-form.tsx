...
export const Route = createFileRoute("/gallery/texture-form")({
  ...
  head: () => ({
    meta: [
      { title: "Texture & Form — Coming Soon | MissKonstruction Photography" },
      { name: "description", content: "Macro details of the everyday — textures, glass, rock formations, and quiet objects worth a second look. Coming soon." },
    ...
    <SiteLayout>
      <section className="container mx-auto px-4 py-12 md:py-16">
        <header className="text-center max-w-xl mx-auto mb-12">
          <h1 className="text-4xl md:text-5xl font-bold">Texture &amp; Form — Coming Soon</h1>
          <img
